...
def main(dirpath, ensemble_names, method="Nelder-Mead", loss_name="f1", th_searh=False, debug=False):
    ...
    result_dict = {"models":ensemble_names, "target":loss_name, "method":method, "weight":results["x"].tolist(), loss_name:results["fun"], "f1":search_results["f1"], "threshold":search_results["threshold"]}
