...
def gs_main(debug=False, mlm=False, pseudo_labeling=None, parallel_strategy_on=False, max_parallel_queues=3, minimum_memory=1500):
    ...
    model_dict = {"microsoft/deberta-v3-large":{"bs":8, "wd":0.01, "ep":3, "rne":True},
                  ...
                  "roberta-base":{"bs":16, "wd":0.1, "ep":5, "rne":True},
                  "microsoft/deberta-v3-base":{"bs":16, "wd":0.01, "ep":5, "rne":True}, 
                  "microsoft/deberta-base":{"bs":16, "wd":0.01, "ep":5, "rne":True},
                  "xlnet-base-cased":{"bs":16, "wd":0.01, "ep":5, "rne":True},
    ...
    for i, config_element in enumerate(config_list):
        ...
        if pseudo_labeling is not None: parse_element += ["-p"] + pseudo_labeling
